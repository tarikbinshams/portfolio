                ...
                {term?.description?.map((des: any, i: any) => {
                  return (
                    <div key={i} className="t-pt-4">
                      <span className=" t-text-[16px] t-font-[sans-bold]  t-text-justify t-leading-8">
                        {des.title}
                      </span>
                      <span className="t-font-[sans-regular] t-text-[16px]  t-text-justify t-leading-8 t-pl-2">
                        {des.value}
                      </span>
                    </div>
                  );
